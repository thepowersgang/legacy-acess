...
#define EXT2_S_IRWXO	0x0007	//!< Global Access rights mask
#define EXT2_S_IROTH	0x0004	//!< Global Read
#define EXT2_S_IWOTH	0x0002	//!< Global Write
#define EXT2_S_IXOTH	0x0001	//!< Global Execute
//! \}
...
struct ext2_dir_entry {
	...
	Uint8	name_type;	//!< Name type
	char	name[EXT2_NAME_LEN];	//!< File name
};

//TYPEDEFS
typedef struct ext2_inode_s			ext2_inode;	//!< Inode Type
typedef struct ext2_super_block_s	ext2_super_block;	//!< Superblock Type
typedef struct ext2_group_desc_s	ext2_group_desc;	//!< Group Descriptor Type
typedef struct ext2_dir_entry_s		ext2_dir_entry;	//!< Directory Entry Type
