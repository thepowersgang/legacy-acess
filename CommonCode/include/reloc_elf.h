...
enum {
	...
	DT_SYMTAB,	//!< Symbol tqable address
	...
	DT_SYMBOLIC,	//!< Reverse order of symbol searching for library, search so first then executable
...
typedef struct elf_header_s	elf_header;
typedef struct elf_shent_s	elf_shent;
